...
#turn into dataframe
df_holidayfarm <- as.data.frame(holidayfarm_sbs, xy = TRUE)
...
#turn into dataframe
df_beachiecreek <- as.data.frame(beachiecreek_sbs, xy = TRUE)
...
#turn into dataframe
df_terwilliger <- as.data.frame(terwilliger_sbs, xy = TRUE)
