...
ggplot(count_df, aes(x = reorder(Ecoregion, -Count), y = Count)) +
  ...
  labs(x = "Ecoregion", y = "Number of Bees", title = "Agapostemon virescens per Ecoregion in Oregon") +
...
ggplot(data = ecoregions_shp) +
  ...
  labs(title = "Agapostemon virescens per Ecoregion in Oregon") +
  theme_minimal() +
  theme(legend.position = "bottom")
```

I got confused with the 500, 750, and 1000 km buffers and after some trial and error decided to focus on the other parts of this section. It kept giving me massive numbers of bees within each ecoregion, something was definitely going wrong. Not sure I fully understood the purpose of that part correctly. Oh well! I hope this take on it works :D.
